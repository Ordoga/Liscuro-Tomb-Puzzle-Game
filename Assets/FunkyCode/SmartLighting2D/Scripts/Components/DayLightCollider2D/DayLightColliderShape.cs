...
public class DayLightColliderShape {
	...
	public DayLightCollider2D.ShapeType shapeType = DayLightCollider2D.ShapeType.SpritePhysicsShape;
    ...
    public List<Polygon2> GetPolygonsWorld() {
		switch(shadowType) {
			...
			case DayLightCollider2D.ShadowType.SpriteProjection:
				switch(shapeType) {
					case DayLightCollider2D.ShapeType.SpritePhysicsShape:
						return(spritePhysicsShape.GetPolygonsWorld());
				
					case DayLightCollider2D.ShapeType.Collider:
